...
<head>
    ...
    <title>@hasSection('title')@yield('title') - @endif CIDAS for CCCPL</title>
...
<body class="min-h-screen">
    <div class="flex flex-col min-h-screen">
        ...
        <main class="flex-1 overflow-y-auto p-8">
            <div class="max-w-7xl mx-auto">
                ...
                'city-created' => 'City saved successfully.',
                'city-updated' => 'City updated successfully.',
    ...
    <script src="{{ asset('js/table-ui.js') }}?v={{ filemtime(public_path('js/table-ui.js')) }}"></script>
